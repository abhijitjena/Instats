...
const Content = (): ReactElement => {
  ...
  return (
    ...
    >
      <div className="pattern-moon pattern-bg-rose-400 pattern-rose-300 pattern-opacity-100 pattern-size-4 w-full h-[80rem] rounded-lg z-30 flex flex-col justify-start shadow-purple-700 shadow-[0_20px_0_0] relative">
        {!is2023contentEmpty ? (
        ...
        {postTrendYearWise.length > 0 ? (
          <>
            <div className="mt-56 mb-32 flex flex-col items-center justify-center bg-rose-100 mx-10 py-10 rounded-md relative">
