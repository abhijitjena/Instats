...
const LikedPosts = (): ReactElement => {
  ...
  return (
    ...
    >
      <div className="pattern-bg-yellow-100 pattern-size-4 pattern-yellow-200 pattern-diagonal-lines pattern-opacity-100 w-full rounded-lg z-30 shadow-orange-600 shadow-[0_20px_0_0]">
        ...
        <div className="flex 2xl:flex-row flex-col items-center 2xl:justify-between justify-around w-full px-20">
          {likedPosts.yearData['2023'] > 0 ? (
            <div className="flex flex-col w-[36%] h-16 items-center justify-center">
              <div className="flex flex-row items-center justify-center relative">
                <p className="text-purple-800 text-8xl font-ultra">
          ...
          <div className="flex w-[54%] flex-col items-center justify-center bg-yellow-100 rounded-lg h-96 relative">
            <RadialBarChart
              width={450}
              height={450}
              innerRadius="10%"
            ...
            <p className="text-rose-400 text-xl font-pikachu bottom-4 absolute">
              Over the years (2023 - 2018)
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center justify-between w-full mt-10 px-20">
          ...
          likedPosts.topCreators[0][1] > 0 ? (
            <div className="w-3/5 mx-[20%] items-center justify-center flex relative">
              <div className="w-full h-32 shadow-yellow-500 shadow-[0_10px_0_0] rounded-xl p-8 relative flex flex-row items-center justify-between pattern-wavy pattern-yellow-100 pattern-opacity-100 pattern-bg-yellow-400 pattern-size-8">
                <div className="absolute -top-[6.6rem] left-[78%] z-40">
                  <img src={catLikes} width={120} height={120} alt="likes cat" />
                </div>
        ...
        <div className="flex flex-row items-center justify-around w-full mb-5 px-10 flex-wrap relative">
          {likedPosts.topCreators.slice(3, likedPosts.topCreators.length).map((value) => {
            if (value[1] > 0)
              return (
                <div
                  key={value[0]}
                  className="likedcreatormini mb-10 mx-6 flex flex-row items-center justify-center"
                >
