...
const PreRequisites = (): ReactElement => {
  const uploadStepView = (props: IUploadStep): ReactElement => {
    ...
    return (
      <div className="w-2/3 lg:w-full my-8 mb-0 lg:mb-8 lg:my-14 h-[33rem] lg:h-[66rem] p-4 lg:p-16 flex flex-row items-start justify-center mx-2">
        <div
          className={`w-60 lg:w-96 h-[30rem] lg:h-[60rem] flex flex-col items-center justify-center ${pattern} pattern-opacity-100`}
        >
          <div className="w-full h-[10rem] lg:h-[12rem] flex flex-col justify-start items-start">
            {textElement()}
          </div>
          <div className="w-[175px] lg:w-[350px] h-[280px] lg:h-[700px] flex flex-col items-center justify-center">
            <img
              src={imgSrc}
              width={window.innerWidth > 1024 ? 400 : 150}
              height={window.innerWidth > 1024 ? 730 : 274}
              alt={imgAlt}
            />
          </div>
        </div>
  ...
  return (
    <div className="my-5 lg:my-10 w-full flex flex-col justify-center items-center relative">
      ...
      <div className="absolute top-8 lg:top-16 left-[70%]">
        <img
          src={sleepyCat1}
          width={window.innerWidth > 1024 ? 160 : 100}
          height={window.innerWidth > 1024 ? 160 : 100}
          alt="sleepy cat"
        />
      </div>
      <div className="w-11/12 lg:w-2/3 my-5 lg:my-14 pattern-zigzag-3d pattern-cyan-300 pattern-bg-cyan-400 pattern-opacity-100 p-4 lg:p-16">
        <p className="text-cyan-800 font-bold text-sm lg:text-lg font-poppins mb-10">
          {
      ...
      <img
        ...
        height={window.innerWidth > 1024 ? 160 : 100}
        alt="lappy cat"
        style={{ marginTop: window.innerWidth > 1024 ? 60 : 30 }}
      />
      <div className="flex steps-carousel flex-row justify-start items-start w-full overflow-x-auto">
        {uploadStepView({
          ...
          textElement: () => {
            return (
              <p className="p-4 lg:p-8 py-0 lg:py-8 w-full text-xs lg:text-base align-middle font-pikachu text-cyan-800">
        ...
        {uploadStepView({
          ...
          textElement: () => {
            return (
              <p className="p-4 lg:p-8 py-0 lg:py-8 w-full text-xs lg:text-base align-middle font-pikachu text-pink-900">
        ...
        {uploadStepView({
          ...
          textElement: () => {
            return (
              <p className="p-4 lg:p-8 py-0 lg:py-8 w-full text-xs lg:text-base align-middle font-pikachu text-orange-700">
        ...
        {uploadStepView({
          ...
          textElement: () => {
            return (
              <p className="p-4 lg:p-8 py-0 lg:py-8 w-full text-xs lg:text-base align-middle font-pikachu text-green-700">
        ...
        {uploadStepView({
          ...
          textElement: () => {
            return (
              <p className="p-4 lg:p-8 py-0 lg:py-8 w-full text-xs lg:text-base align-middle font-pikachu text-violet-800">
        ...
        {uploadStepView({
          ...
          textElement: () => {
            return (
              <p className="p-4 lg:p-8 py-0 lg:py-8 w-full text-xs lg:text-base align-middle font-pikachu text-yellow-500">
        ...
        {uploadStepView({
          ...
          textElement: () => {
            return (
              <p className="p-4 lg:p-8 py-0 lg:py-8 w-full text-xs lg:text-base align-middle font-pikachu text-red-500">
        ...
        {uploadStepView({
          ...
          textElement: () => {
            return (
              <p className="p-4 lg:p-8 py-0 lg:py-8 w-full text-xs lg:text-base align-middle pattern-bg- font-pikachu text-blue-500">
        ...
        {uploadStepView({
          ...
          textElement: () => {
            return (
              <p className="p-4 lg:p-8 py-0 lg:py-8 w-full text-xs lg:text-base align-middle font-pikachu text-amber-500">
        ...
        {uploadStepView({
          ...
          textElement: () => {
            return (
              <p className="p-4 lg:p-8 py-0 lg:py-8 w-full text-xs lg:text-base align-middle text-center font-pikachu text-lime-700">
        ...
        {uploadStepView({
          ...
          textElement: () => {
            return (
              <p className="p-4 lg:p-8 py-0 lg:py-8 w-full text-xs lg:text-base align-middle text-center font-pikachu text-fuchsia-700">
        ...
        {uploadStepView({
          ...
          textElement: () => {
            return (
              <p className="p-4 lg:p-8 py-0 lg:py-8 w-full text-xs lg:text-base align-middle text-center font-pikachu text-emerald-700">
      ...
      <div className="mb-40 w-11/12 lg:w-2/3 mt-10 px-4 lg:px-16 py-5 lg:py-10 bg-lime-300 relative">
        <p className="text-lime-700 text-xs lg:text-base font-poppins font-bold">
